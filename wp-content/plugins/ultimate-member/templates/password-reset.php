				...
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<?php _e( 'We have sent you a password reset link to your e-mail. Please check your inbox.', 'ultimate-member' ); ?></div>
					</div>
				</div>
			<?php } else { ?>
				...
				<?php } else { ?>
					<div class="um-field um-field-block um-field-type_block">
						<div class="um-field-block">
							...
							أدخل بريدك الالكتروني الذي قمت بالتسجيل به و سيصلك رابط لإعادة تعيين كلمة المرور.
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						...
						<input type="submit" value="أرسل" class="um-button" id="um-reset-submit-btn" />
					</div>
