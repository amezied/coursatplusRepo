...
if (!empty($curriculum)):
    ...
    <div class="stm-curriculum">
		...
		<?php foreach ($curriculum as $curriculum_item): ?>
            ...
            <div class="stm-curriculum-item <?php if(!empty($lesson_excerpt)) echo esc_attr('has-excerpt'); ?> <?php if($lesson_number==1) echo esc_attr('opened'); ?>"
                ...
                <?php if(!empty($lesson_excerpt)): ?>
                    <div class="stm-curriculum-item__excerpt" style="<?php if($lesson_number==1) echo esc_attr('display:block;'); ?>">
