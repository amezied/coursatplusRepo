    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'logo_text_font',
                'type' => 'typography',
                'title' => __('Logo Typography', 'stm-post-type'),
                'compiler' => true,
                'google' => true,
                'font-backup' => false,
                'font-weight' => false,
...
',
    ...
    Redux::setSection($opt_name, array(
        'title' => __('Sidebars', 'stm-post-type'),
        'desc' => '',
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            array(
                ...
                'color' => true,
                'preview' => true,
                'output' => array('body, .normal_font,body.rtl.rtl-demo .stm_testimonials_wrapper_style_2 .stm_lms_testimonials_single__excerpt p'),
                'units' => 'px',
    ...
    Redux::setSection($opt_name, array(
        'title' => __('Google API', 'stm-post-type'),
        'icon' => 'el-icon-paper-clip',
        'submenu' => true,
        'fields' => array(
            array(
                ...
                'type' => 'text',
                'title' => __('Recaptcha Public key', 'stm-post-type'),
                'default' => ""
            ),
            array(
                'id' => 'g_recaptcha_private_key',
                'type' => 'text',
                'title' => __('Recaptcha Private key', 'stm-post-type'),
                'default' => ""
            ),
        )
    ));
