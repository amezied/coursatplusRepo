...
if (class_exists('STM_LMS_Helpers')):
	...
	stm_module_styles('courses_carousel', 'style_1', array(), $inline);
	stm_module_scripts('courses_carousel', 'style_1');
    ...
    <div class="stm_lms_courses_carousel_wrapper <?php echo esc_attr($uniq); ?> <?php if ($prev_next === 'disable') {
        ...
        <div class="stm_lms_courses_carousel"
			...
			<div class="main-page-courses">
				
				<?php if ($prev_next !== 'disable'): ?>
                <div class="stm_lms_courses_carousel__buttons customNavigation">
                    <span class="pager-left stm_lms_courses_carousel__button stm_lms_courses_carousel__button_prev sbc_h sbrc_h"><i class="fas fa-chevron-right" aria-hidden="true"></i></span>
                    
					<span class="pull-circle">اسحب</span>
					<span class="pager-right stm_lms_courses_carousel__button stm_lms_courses_carousel__button_next sbc_h sbrc_h">
			...
			<?php endif; ?>
                    ...
                    <a class="btn view-all-btn" href="<?php echo get_page_link( get_page_by_title( 'الكورسات' )); ?>">عرض جميع الكورسات</a>
                </div>
                ...
                <div class="stm_lms_courses_carousel__top">
					...
					<?php if (!empty($terms)): ?>
                        <div class="stm_lms_courses_carousel__terms">
                            <div class="stm_lms_courses_carousel__term active secondary_color"><?php esc_html_e('All categories', 'masterstudy'); ?></div>
			...
			<?php if ($prev_next !== 'disable'): ?>
                <div class="stm_lms_courses_carousel__buttons bottomNav">
...
التالي
			...
			<div class="sepBottom"><div class="seperator35"></div></div>
			<?php endif; ?>
